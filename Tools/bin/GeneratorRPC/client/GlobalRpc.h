...
namespace Client
{
	...
	public:
		...
		Msg::ObjectMsgCall<Object> * TestObject_RpcTimeout(g_rpcDefaultParam_INT32 , g_rpcDefaultParam_INT32, std::vector<Msg::Object> vecTargets = VECTOR_TARGETS_NULL , Msg::Object objSrc = Msg::Object(Msg::DEFAULT_RPC_CALLABLE_ID));
		Msg::ObjectMsgCall<Object> * TestObject_RpcClient(g_rpcDefaultParam_INT32 , g_rpcDefaultParam_INT32, std::vector<Msg::Object> vecTargets = VECTOR_TARGETS_NULL , Msg::Object objSrc = Msg::Object(Msg::DEFAULT_RPC_CALLABLE_ID));
		//TestObject1 generate RPC func here
		Msg::ObjectMsgCall<Object> * TestObject1_RpcTimeout(g_rpcDefaultParam_INT32 , g_rpcDefaultParam_INT32, std::vector<Msg::Object> vecTargets = VECTOR_TARGETS_NULL , Msg::Object objSrc = Msg::Object(Msg::DEFAULT_RPC_CALLABLE_ID));
		Msg::ObjectMsgCall<Object> * TestObject1_RpcClient(g_rpcDefaultParam_INT32 , g_rpcDefaultParam_INT32, std::vector<Msg::Object> vecTargets = VECTOR_TARGETS_NULL , Msg::Object objSrc = Msg::Object(Msg::DEFAULT_RPC_CALLABLE_ID));
	};
}
