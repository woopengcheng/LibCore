...
Msg::ObjectMsgCall * Server::ServerHandler::HandleHDel_RpcServer(Net::ISession * pSession, Msg::Object objSrc , std_string &table/* = std::string()*/ , std_string & key/* = std::string()*/  )
{
	INT32 res = -1;
