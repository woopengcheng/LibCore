...
Msg::ObjectMsgCall * Server::ServerHandler::HandleZSet_RpcServer(std::vector<Msg::Object> vecTargets , Msg::Object objSrc , std_string &table  , std_string & key , INT64 score)
{
	INT32 res = -1; 
