...
#define  RPC_DEFINE_ServerHandler public:\
	...
	Msg::ObjectMsgCall * testParamsAndRpcDatas_RpcTimeout(Net::ISession * pSession , Msg::Object objSrc = Msg::Object(Msg::DEFAULT_RPC_CALLABLE_ID) , TestRpcData & rpcData = TestRpcData() , TestRpcData2 & rpcData2 = TestRpcData2() , LibCore_Chunk & value = LibCore::Chunk() , std::vector<INT32> & Vec = std::vector<INT32>(1));\
...
#define  RPC_DEFINE_MasterHandler public:\
	...
	Msg::ObjectMsgCall * testMulitServerNode_RpcTimeoutProxy(Net::ISession * pSession , Msg::Object objSrc = Msg::Object(Msg::DEFAULT_RPC_CALLABLE_ID) , std_string & dbname = std::string() , LibCore_Chunk & value = LibCore::Chunk() , int value2 = 0 , unsigned int value22 = 0 , char valChar = char(0));\
	Msg::ObjectMsgCall * testMulitServerNode_RpcClientProxy(Net::ISession * pSession , Msg::Object objSrc = Msg::Object(Msg::DEFAULT_RPC_CALLABLE_ID) , LibCore_Chunk & res = LibCore::Chunk());\
	Msg::ObjectMsgCall * testParamsAndRpcDatas_RpcServer(Net::ISession * pSession , Msg::Object objSrc = Msg::Object(Msg::DEFAULT_RPC_CALLABLE_ID), TestRpcData & rpcData = TestRpcData() , TestRpcData2 & rpcData2 = TestRpcData2() , LibCore_Chunk & value = LibCore::Chunk() , std::vector<INT32> & Vec = std::vector<INT32>(1));\
