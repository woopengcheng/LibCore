...
#define  RPC_DEFINE_ServerHandler public:\
	Msg::ObjectMsgCall * HandleZSet_RpcServer(std_string table = std::string() , INT64 score = 0 , std_string key = std::string(), std::vector<Msg::Object> vecTargets = VECTOR_TARGETS_NULL , Msg::Object objSrc = Msg::Object(Msg::DEFAULT_RPC_CALLABLE_ID));\
