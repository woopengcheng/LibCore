...
Msg::ObjectMsgCall * Server::ServerHandler::HandleZRTop_RpcServer(std::vector<Msg::Object> vecTargets , Msg::Object objSrc , std_string &table/* = std::string()*/ , INT64 start/* = 0*/ , INT64 end/* = 0*/ , INT64 limit/* = 0*/  )
{
	LibCore_Chunk res;
