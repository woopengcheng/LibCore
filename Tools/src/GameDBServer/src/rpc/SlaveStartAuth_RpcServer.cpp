...
Msg::ObjectMsgCall * Server::ServerHandler::SlaveStartAuth_RpcServer(std_string &name/* = std::string()*/ , std_string & pwd/* = std::string()*/, std::vector<Msg::Object> vecTargets , Msg::Object objSrc )
{
