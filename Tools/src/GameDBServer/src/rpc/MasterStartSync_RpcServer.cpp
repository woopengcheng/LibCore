...
Msg::ObjectMsgCall * Server::SlaveHandler::MasterStartSync_RpcServer(std::vector<Msg::Object> vecTargets , Msg::Object objSrc , std_string &filename/* = std::string()*/ , INT32 filesize/* = 0*/ , INT32 sendtype/* = 0*/ , LibCore_Chunk & value/* = LibCore::Chunk()*/  )
{
	INT32 res = 0;
