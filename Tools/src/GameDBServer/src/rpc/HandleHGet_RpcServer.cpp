...
Msg::ObjectMsgCall * Server::ServerHandler::HandleHGet_RpcServer(std_string key/* = std::string()*/ , std_string table/* = std::string()*/, std::vector<Msg::Object> vecTargets , Msg::Object objSrc )
{
