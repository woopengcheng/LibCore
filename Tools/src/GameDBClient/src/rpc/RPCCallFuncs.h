...
{ 
	...
	static INT32  local_call_TestObject(const char * pSessionName , char p1 , INT16 p2, UINT16 p3 , INT32 p4 , UINT32 p5 , const char * p6 , LibCore::Chunk p7 , std::vector<Msg::Object> vecTargets , Msg::Object objSrc , UINT16 usPriority = 0 , EMSG_SYNC_TYPE objSyncType = SYNC_TYPE_SYNC)
	{ 
