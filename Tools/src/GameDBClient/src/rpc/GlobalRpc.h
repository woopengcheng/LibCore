...
namespace Msg
{
	...
	public:
		...
		Msg::ObjectMsgCall * HandleHSet_RpcTimeout(std_string value = std::string() , std_string key = std::string() , std_string table = std::string(), std::vector<Msg::Object> vecTargets = VECTOR_TARGETS_NULL , Msg::Object objSrc = Msg::Object(Msg::DEFAULT_RPC_CALLABLE_ID));
		...
		Msg::ObjectMsgCall * HandleHGet_RpcTimeout(std_string key = std::string() , std_string table = std::string(), std::vector<Msg::Object> vecTargets = VECTOR_TARGETS_NULL , Msg::Object objSrc = Msg::Object(Msg::DEFAULT_RPC_CALLABLE_ID));
