...
{ 
	...
	//			CUtil::Chunk objChunk(objValue.objdata(),objValue.objsize()).;
				...
				Client::rpc_HandleHSet(g_strGameDBNodes[NETNODE_DBCLIENT_TO_DBSERVER] , targets , Msg::Object(0) , strTable , strKey , strValue , 1);
			}
			break;
		case OPERATION_UPDATE:
			{ 
				...
				std::vector<Msg::Object> targets;
				targets.push_back(Msg::Object(1));   
				Client::rpc_HandleHGet(g_strGameDBNodes[NETNODE_DBCLIENT_TO_DBSERVER], targets , Msg::Object(0) , strTable , strKey  , 1);
