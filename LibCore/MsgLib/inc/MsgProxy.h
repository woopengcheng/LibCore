...
//   #ifdef USE_MSG_PROXY
//   	
//   	static BOOL  local_call_Test(char p1 , INT16 p2, UINT16 p3 , INT32 p4 , UINT32 p5 , const char * p6 , Chunk p7 , Object objTarget , Object objSrc , UINT16 usPriority = 0)
//   	{ 
//   		vector vecTargets;
...
//   
//   			GenMsgHelper::GenMsgCall(*pMsg , 0 , sz_local_call_Test , vecTargets , objSrc , usPriority);
...
//   			ObjectMsgCall * pMsg = new(sizeof(Object)*vecTargets.size())ObjectMsgCall;  
//   
//   			GenMsgHelper::GenMsgCall(*pMsg , 0 , sz_local_call_WorldTest , vecTargets , objSrc , usPriority);
//   			GenMsgHelper::GenMsgParams(pMsg->m_objParams , p1 , p2 , p3 , p4 , p5 , p6 , p7);
//   
//   			InnerMsg::GetInstance().SendMsg(pMsg);
//   		}
