...
{ 
	...
	public:
		virtual CErrno			InsertNode(UINT32 unNodeID ,TimerNode * pNode , bool bRemoveSame = true) = 0 ;
		virtual CErrno			RemoveNode(UINT32 unNodeID) = 0;
		virtual TimerNode	*	GetNode(UINT32 unNodeID) = 0;
	};   
} 
#endif