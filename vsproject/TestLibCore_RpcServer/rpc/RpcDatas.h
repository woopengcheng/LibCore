...
{ 
	...
	template<> class Msg::ParameterHelper<Server::UserLogin>
	{ 
	public:
		...
		static Server::UserLogin GetParameterValue(Parameter & objParam)
		{ 
			INT32 unType = 0;
			Server::UserLogin val;
		...
		static void MakeParameter(Parameter & objParam , Server::UserLogin val)
		{ 
	...
	public:
		...
		static Server::UserLogin GetParameterValue(Parameter & objParam)
		{ 
			return ParameterHelper<Server::UserLogin>::GetParameterValue(objParam);

		} 
		static void MakeParameter(Parameter & objParam , Server::UserLogin val)
		{ 
			return ParameterHelper<Server::UserLogin>::MakeParameter(objParam , val);
		} 
