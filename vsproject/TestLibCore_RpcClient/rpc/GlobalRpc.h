...
namespace Msg
{
	...
	public:
		...
		Msg::ObjectMsgCall * TestObject_RpcTimeout(UINT32 userid7 = 0 , UINT64 userid9 = 0 , UINT16 localid4 = 0 , SINT8 userid1 = 0 , INT16 userid3 = 0 , INT64 localid8 = 0 , INT32 localid6 = 0, std::vector<Msg::Object> vecTargets = VECTOR_TARGETS_NULL , Msg::Object objSrc = Msg::Object(Msg::DEFAULT_RPC_CALLABLE_ID));
