...
{ 
	...
	template<> class Msg::ParameterHelper<Client::UserLogin>
	{ 
	public:
		...
		static Client::UserLogin GetParameterValue(Parameter & objParam)
		{ 
			INT32 unType = 0;
			Client::UserLogin val;
		...
		static void MakeParameter(Parameter & objParam , Client::UserLogin val)
		{ 
	...
	public:
		...
		static Client::UserLogin GetParameterValue(Parameter & objParam)
		{ 
			return ParameterHelper<Client::UserLogin>::GetParameterValue(objParam);

		} 
		static void MakeParameter(Parameter & objParam , Client::UserLogin val)
		{ 
			return ParameterHelper<Client::UserLogin>::MakeParameter(objParam , val);
		} 
