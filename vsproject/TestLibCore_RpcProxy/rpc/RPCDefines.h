#ifndef __msg_Proxy_rpc_defines_h__
#define __msg_Proxy_rpc_defines_h__
...
#define  RPC_DEFINE_GlobalRpc public:\
	...
	Msg::ObjectMsgCall * TestObject1_RpcServer(Net::ISession * pSession , Msg::Object objSrc = Msg::Object(Msg::DEFAULT_RPC_CALLABLE_ID), SINT8 userid1 = 0 , UINT8 localid2 = 0 , INT16 userid3 = 0 , UINT16 localid4 = 0 , double localid10 = 1.0f , float localid11 = 1.0f , std_string localid12 = std::string() , LibCore_Chunk localid13 = LibCore::Chunk());\
public:\
